...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'site_ab2551d64fddb6181462_20240615235611_archive.zip';
        const ARCHIVE_SIZE       = '278190620';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ab2551d-15235611';
        const SECONDARY_PACKAGE_HASH = 'a8cb826-15235611';
        const VERSION            = '1.5.9';
